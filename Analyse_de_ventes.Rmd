...
![](C:/Users\Elena\Pictures\lapage.jpg)  
...
### Dictionnaire de traitement des données 
...
hist(x = df_ca_norm$CA_client,xlab="CA de clients",ylab="", main="Without outliers" )
```
...
fig <- fig %>% layout(title = "chiffre d'affaires par categories",
